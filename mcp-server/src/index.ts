...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  switch (name) {
    case "lookup_site_structure": {
      ...
      const language = ((args as any).language as string) || "english";
    ...
    case "get_brand_rules": {
      const section = ((args as any).section as string) || "all";
      let result: any = {};
    ...
    case "read_phase_data": {
      const pageName = (args as any).page_name as string;
      const phase = (args as any).phase as number;
    ...
    case "convert_to_docx": {
      const files = (args as any).files as string[];
    ...
    case "submit_feedback": {
      const { page_name, rating, issues, improvements, submitter } = args as any;
    ...
    case "get_template_info": {
      const templateNumber = (args as any).template_number as number;
