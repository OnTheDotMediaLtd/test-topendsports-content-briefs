...
**API Key:** SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z
...
curl -H "Authorization: Bearer SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z" \
...
curl -H "Authorization: SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z" \
  "https://api.ahrefs.com/v3/site-explorer/domain-rating?target=ahrefs.com&date=2025-12-01"
# Result: 403 Forbidden - ["Error","Forbidden"]

# Token prefix instead of Bearer
curl -H "Authorization: Token SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z" \
  "https://api.ahrefs.com/v3/site-explorer/domain-rating?target=ahrefs.com&date=2025-12-01"
# Result: 503 Service Unavailable - Certificate verification error

# Query parameter authentication
curl "https://api.ahrefs.com/v3/site-explorer/domain-rating?target=ahrefs.com&date=2025-12-01&token=SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z"
# Result: 403 Forbidden - ["Error","Forbidden"]

# X-API-Key header
curl -H "X-API-Key: SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z" \
  "https://api.ahrefs.com/v3/site-explorer/domain-rating?target=ahrefs.com&date=2025-12-01"
# Result: 403 Forbidden - ["Error","Forbidden"]
```
...
```bash
# Standard Bearer token (RECOMMENDED)
wget --header="Authorization: Bearer SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z" \
...
```bash
# Query parameter authentication
wget -O - "https://api.ahrefs.com/v3/site-explorer/domain-rating?target=ahrefs.com&date=2025-12-01&token=SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z"
...
response = requests.get(
    ...
    headers={'Authorization': 'Bearer SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z'},
...
response = requests.get(
    'https://api.ahrefs.com/v3/site-explorer/domain-rating',
    params={'target': 'ahrefs.com', 'date': '2025-12-01'},
    headers={'Authorization': 'SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z'},
...
response = requests.get(
    'https://api.ahrefs.com/v3/site-explorer/domain-rating',
    params={'target': 'ahrefs.com', 'date': '2025-12-01'},
    headers={'Authorization': 'Token SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z'},
    verify='/etc/ssl/certs/ca-certificates.crt'
)
...
response = requests.get(
    'https://api.ahrefs.com/v3/site-explorer/domain-rating',
    params={'target': 'ahrefs.com', 'date': '2025-12-01'},
    headers={'X-API-Key': 'SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z'},
    verify='/etc/ssl/certs/ca-certificates.crt'
)
# Result: 403 Forbidden
...
# Query parameter authentication
response = requests.get(
    'https://api.ahrefs.com/v3/site-explorer/domain-rating?token=SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z',
    params={'target': 'ahrefs.com', 'date': '2025-12-01'},
    verify='/etc/ssl/certs/ca-certificates.crt'
)
# Result: 403 Forbidden
...
const response = await fetch(
    ...
    {
        headers: {
            'Authorization': 'Bearer SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z'
        }
    }
);
// Error: fetch failed
...
```
Authorization: SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z
```
**Result:** 403 Forbidden

### ❌ FAILED: Token Prefix
```
Authorization: Token SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z
```
**Result:** 503 Service Unavailable (causes cert errors)

### ❌ FAILED: X-API-Key Header
```
X-API-Key: SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z
```
**Result:** 403 Forbidden

### ❌ FAILED: Query Parameter
```
?token=SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z
```
**Result:** 403 Forbidden
...
3. **Create a wrapper class:**
   ...
   # Usage:
   api = AhrefsAPI('SjPt1JPhRgqMpi5UN8G7e8P3s57SjW86734J2r1Z')
